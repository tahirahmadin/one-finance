...
export default function DCATopCard() {
    ...
    <Box className={classes.cardTop}>
            ...
            >
              ...
              <Box ml={2}>
                ...
                <Typography
                  ...
                  color={"#bdbdbd"}
                >
                  Start the strategy and buy tokens to make better average
                  price.
                </Typography>
              </Box>
            </Box>
      ...
      {!md && (
        <Typography variant="small" color="#bdbdbd">
          * Investment of <strong>atleast 20 orders</strong> is adviced for best
          results.
        </Typography>
      )}
    </Box>
